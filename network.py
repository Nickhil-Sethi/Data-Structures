...
class AdjacencySet(AVLTree):
    """AdjacencySet set object implemented by AVLTree."""
    def __init__(self):
...
class DirectedGraph(object):
    ...
    def BFS(self,s):
        """Breadth first search beginning at node s
        ...
        explored : type set
            Connected component generated by s"""
    ...
    def DFS(self,s):
        """Depth first search beginning at s
